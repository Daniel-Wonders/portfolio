        ...
        <div id="projectContainer">
            <div id="project3" className="project">
                ...
                <div className="container">
                    ...
                    <p>The website you're looking at right now was made using different routes from React Router. I also made it responsive so it can be displayed from any device.</p>
            ...
            <div id="project2" className="project">
                <div className="container">
                    ...
                    <div className="btnContainer2">
                        <a rel="noreferrer" href="https://daniel-wonders.github.io/anime-quiz/" target="_blank" className="btns">Website</a>
                        <a rel="noreferrer" href="https://github.com/Daniel-Wonders/anime-quiz" target="_blank" className="btns btns2">Source Code</a>
                    </div>
                </div>
            <img alt="Trivia website" src={process.env.PUBLIC_URL+"/animeQuiz.png"} />
            </div>
            <div id="project1" className="project">
                <img alt="meme generation website"  src={process.env.PUBLIC_URL+"/memeGenerator.jfif"} />
                <div className="container">
                    ...
                    <div className="btnContainer2">
                        <a rel="noreferrer" href="https://daniel-wonders.github.io/meme-generator/" target="_blank" className="btns">Website</a>
                        <a rel="noreferrer" href="https://github.com/Daniel-Wonders/meme-generator" target="_blank" className="btns btns2">Source Code</a>
                    </div>
                </div>
            </div>
